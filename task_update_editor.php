<?php
function task_update_editor(){
    $i=$_GET['id'];
    global $wpdb;
    $table_name = $wpdb->prefix . 'task';
    $tasks = $wpdb->get_results("SELECT id,name,address,date,role,user_nicename from $table_name where id=$i");
    echo $tasks[0]->id;
    ?>
    <style>
  h1{
...
::-webkit-scrollbar-thumb {
    ...
    <table cellpadding="0" cellspacing="0" border="0">
        ...
        <form name="frm" action="#" method="post">
            ...
            <tr>
                <td>Task Notes</td>
                <td><input type="text" name="adrs" value="<?= $tasks[0]->address; ?>"></td>
            </tr>
            <tr>
                <td>Status:</td>
